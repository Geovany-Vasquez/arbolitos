...
public void RecorridoInorden(DefaultMutableTreeNode nodoRaiz)
    {
        if(!nodoRaiz.getUserObject().toString().equals("I - NULL") && !nodoRaiz.getUserObject().toString().equals("D - NULL"))
        {
            RecorridoInorden((DefaultMutableTreeNode) nodoRaiz.getFirstChild()); //izquierda
            strRecorrido += nodoRaiz.getUserObject().toString().split("-")[1].trim() + " - "; //principal
            RecorridoInorden((DefaultMutableTreeNode) nodoRaiz.getLastChild());  //derecha
        }
    }
public void RecorridoPostorden(DefaultMutableTreeNode nodoRaiz)
    {
        if(!nodoRaiz.getUserObject().toString().equals("I - NULL") && !nodoRaiz.getUserObject().toString().equals("D - NULL"))
        {
            RecorridoPostorden((DefaultMutableTreeNode) nodoRaiz.getFirstChild()); //izquierda
            RecorridoPostorden((DefaultMutableTreeNode) nodoRaiz.getLastChild());  //derecha
            strRecorrido += nodoRaiz.getUserObject().toString().split("-")[1].trim() + " - "; //principal
